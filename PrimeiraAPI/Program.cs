...
var versionDescripterProvider = app.Services.GetRequiredService<IApiVersionDescriptionProvider>();
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        foreach (var description in versionDescripterProvider.ApiVersionDescriptions)
